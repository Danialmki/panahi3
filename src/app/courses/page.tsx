      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            مجموعه جامع دوره‌های زبان ما را کشف کنید که برای کمک به شما در تسلط
            بر انگلیسی، روسی و اسپانیایی با سرعت خود طراحی شده است
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-2 mb-6">
          {languages.map((language) => (
            ...
            >
              {language === "all" ? "همه زبان‌ها" : language}
            </button>
          ))}
        </div>
        ...
        {!loading && !error && courses.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">
              سطح دیگری را انتخاب کنید یا بعداً برای دوره‌های جدید بررسی کنید.
            </p>
          </div>
        )}
      </div>
